            ...
            <div key={project.title} className="project-card">
              <div className="project-header">
                <div className="project-title-row">
                  <h3>{project.title}</h3>
                  <span className={`project-badge ${project.badgeClass}`}>{project.status}</span>
                </div>
                {project.github && (
                  <div className="project-links-row">
                    <a href={project.github} className="plink" target="_blank" rel="noreferrer">↗ GitHub</a>
                  </div>
                )}
              </div>
              ...
              {project.leftBlock && (
                <div className="two-col">
                  <DetailBlock title={project.leftBlock.title} items={project.leftBlock.items} />
                  {project.arch ? (
                    <div className="arch" dangerouslySetInnerHTML={{ __html: project.arch }} />
                  ) : (
                    <DetailBlock title={project.rightBlock.title} items={project.rightBlock.items} />
                  )}
                </div>
              )}

              {project.standaloneBlock && (
                <DetailBlock title={project.standaloneBlock.title} items={project.standaloneBlock.items} />
              )}

              <div className="tags" style={project.standaloneBlock ? { marginTop: '12px' } : undefined}>
